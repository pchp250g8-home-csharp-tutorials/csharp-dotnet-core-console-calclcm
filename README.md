...
Программа делает следующее:
  ...
  2. Сравнивает каждое с нулём.
     Если хотя бы одно из них равно нулю, программа выводит сообщение о том, что числа не должны быть рамными нулю и завершает работу.
